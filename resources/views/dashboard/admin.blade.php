...
<div class="space-y-6" x-data>
    ...
    <div>
        <h2 class="text-xl font-black text-slate-800 tracking-tight">Aktivitas Toko Hari Ini</h2>
        <p class="text-sm text-slate-400 mt-0.5">Ringkasan aktivitas dan kondisi stok terkini.</p>
    </div>
